...
## Лабораторная работа 1 - [ЛР1](https://sourcecraft.dev/prig6ivt/lr1?rev=main)

## Лабораторная работа 2 - [ЛР2](https://github.com/MelnikNO/prog6sem3c/tree/main/LR2#readme)
...
## Командный проект - [Разработка ML-сервиса для предсказания одобрения ипотеки](https://sourcecraft.dev/prig6ivt/mlprojectbsm)
